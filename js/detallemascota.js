...
let mascotas = JSON.parse(localStorage.getItem('pets'))
...
function cargarDetalleMascota(mascota) {
    document.querySelector('.mascota').innerHTML = `<a class="regresar" href="home.html">
    <img src="../img/regresar.png" ></a>
    <img class= "imagenperfilp" src="${mascota.img2}" alt="${mascota.nombre}" style="width: 60%; height: 10%;">`
    ...
    document.querySelector('.detallemascota').innerHTML = `<section class="content">
        ...
        <section class="row mb-3" class="ultimo">
            ...
            <div class="col-4"><a href="../html/contacto.html?id=${mascota.publicadoPor.id}"><img class="botoncontactar" src="https://i.ibb.co/kcYb6Lz/contactar.png" alt=""></a></div>
        </section>`
}
